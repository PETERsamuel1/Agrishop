...
import com.devops.agrishop.utility.EmployeesAdapter;
...
public class AdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mProgressbar = findViewById(R.id.adminprogressBar);
                ...
                builder.setMultiChoiceItems(departments, checked, new DialogInterface.OnMultiChoiceClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which, boolean isChecked) {
                        if(isChecked){
                            ...
                            mDepartments.setText(mSelectedDepartments.toString());
                        }else{
    ...
    /*
    *Send message to selected departments
     */
        ...
        for(String token :  mTokens){
            ...
            call.enqueue(new Callback<ResponseBody>() {
                ...
                public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                    ...
                    Toast.makeText(AdminActivity.this,"Success....msg send", Toast.LENGTH_LONG).show();
                }
                ...
                public void onFailure(Call<ResponseBody> call, Throwable t) {
                    ...
                    Toast.makeText(AdminActivity.this, "Error, Try again", Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
    ...
    public void getDepartments(){
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference();
        Query query = reference.child("ENACTUS UOE").child(getString(R.string.dbnode_departments));
