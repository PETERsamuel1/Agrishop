...
public class ChatMessageSentListAdapter extends ArrayAdapter<ChatMessage> {

    private static final String TAG = "ChatMessageSentAdapter";

    private int mLayoutResource;
    private Context mContext;

    public ChatMessageSentListAdapter(@NonNull Context context, @LayoutRes int resource, @NonNull List<ChatMessage> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            holder.message = (TextView) convertView.findViewById(R.id.text_message_body_sent);
           // holder.mProfileImage = convertView.findViewById(R.id.image_message_profile);
            holder.date = convertView.findViewById(R.id.text_message_time_sent);
