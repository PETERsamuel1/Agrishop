...
import com.devops.agrishop.AccountActivity;
import com.devops.agrishop.AdminActivity;
import com.devops.agrishop.ChatActivity;
import com.devops.agrishop.ChatroomActivity;
import com.devops.agrishop.DetailActivity;
import com.devops.agrishop.LoginActivity;
import com.devops.agrishop.MainActivity;
import com.devops.agrishop.PhoneActivity;
import com.devops.agrishop.R;
import com.devops.agrishop.RegisterActivity;
import com.devops.agrishop.Splash;
import com.devops.agrishop.UserDetailsActivity;
import com.devops.agrishop.VerifyPhoneActivity;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
	...
	//	Log.d(TAG, "onMessageReceived: notification title: " + notificationTitle);
		...
		//SITUATION: Application is in background or closed
			...
			if(identifyDataType.equals(getString(R.string.data_type_admin_broadcast))){
				...
				Query query = FirebaseDatabase.getInstance().getReference().child("ENACTUS UOE").child(getString(R.string.dbnode_chatrooms))
						.orderByKey()
						.equalTo(chatroomId);
	...
	private boolean isApplicationInForeground(){
		...
		|| ChatActivity.isActivityRunning || AdminActivity.isActivityRunning
				...
				|| RegisterActivity.isActivityRunning || AccountActivity.isActivityRunning
				|| Splash.isActivityRunning || PhoneActivity.isActivityRunning
				|| VerifyPhoneActivity.isActivityRunning || DetailActivity.isActivityRunning
				|| UserDetailsActivity.isActivityRunning;
